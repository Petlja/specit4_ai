...
*Пример промптова скупа HumanEval*
...
Велике језичке моделе попут *ChatGPT*-a или *BART*-a можеш користити уз претходно отварање налога. На платформи `Huggingface <https://huggingface.co/>`_ 
...
Сада можеш да тестираш рад овог сервиса тако што ћеш задати неки свој промпт или искористити неки од промптова које сервис нуди као понуђене: 
- ``def print_hello_world():``, 
- ``def count_lines(filename):`` и 
